...
const getStyles = (id: string, selectedSpecialtyIds: readonly string[], theme: Theme) => {
    return {
        fontWeight:
            selectedSpecialtyIds.indexOf(id) === -1
                ? theme.typography.fontWeightRegular
                : theme.typography.fontWeightMedium,
    };
};

const MultipleSpecialtySelectInput = ({
    allSpecialties,
    setSelectedIds,
    selectedIds,
}: any) => {
...
export default MultipleSpecialtySelectInput;
