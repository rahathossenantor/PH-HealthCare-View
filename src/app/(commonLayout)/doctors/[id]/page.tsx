...
const DoctorDetails = ({ params: { id } }: TDoctorDetailsPropTypes) => {
    const { data: doctor, isLoading } = useGetSingleDoctorQuery(id);
    const specialties = doctor?.doctorSpecialty?.map(({ specialty }: any) => (specialty?.title));
                    ...
                    <Stack sx={{ bgcolor: "white", p: 3 }}>
                        ...
                        >
                            ...
                            <Box sx={infoBoxStyles}>
                                ...
                                <Typography>{doctor?.avgRating === 0 ? "0" : doctor?.avgRating}</Typography>
                            </Box>
                            <Box sx={infoBoxStyles}>
